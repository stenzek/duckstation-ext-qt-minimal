...
get_target_property(_qt_imported_location Qt6::Network IMPORTED_LOCATION_RELWITHDEBINFO)
get_target_property(_qt_imported_soname Qt6::Network IMPORTED_SONAME_RELWITHDEBINFO)
get_target_property(_qt_imported_location_default Qt6::Network IMPORTED_LOCATION_${QT_DEFAULT_IMPORT_CONFIGURATION})
get_target_property(_qt_imported_soname_default Qt6::Network IMPORTED_SONAME_${QT_DEFAULT_IMPORT_CONFIGURATION})
...
if(_qt_imported_location)
    set_property(TARGET Qt6::Network PROPERTY IMPORTED_LOCATION_RELEASE "${_qt_imported_location}")
endif()
if(_qt_imported_soname)
    set_property(TARGET Qt6::Network PROPERTY IMPORTED_SONAME_RELEASE "${_qt_imported_soname}")
endif()
...
if(_qt_imported_soname)
    set_property(TARGET Qt6::Network PROPERTY IMPORTED_SONAME_MINSIZEREL "${_qt_imported_soname}")
endif()
...
if(_qt_imported_soname_default)
    set_property(TARGET Qt6::Network PROPERTY IMPORTED_SONAME "${_qt_imported_soname_default}")
endif()
