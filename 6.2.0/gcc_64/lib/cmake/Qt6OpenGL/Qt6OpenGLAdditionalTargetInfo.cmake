...
get_target_property(_qt_imported_soname Qt6::OpenGL IMPORTED_SONAME_RELWITHDEBINFO)
get_target_property(_qt_imported_location_default Qt6::OpenGL IMPORTED_LOCATION_${QT_DEFAULT_IMPORT_CONFIGURATION})
get_target_property(_qt_imported_soname_default Qt6::OpenGL IMPORTED_SONAME_${QT_DEFAULT_IMPORT_CONFIGURATION})
...
if(_qt_imported_soname)
    set_property(TARGET Qt6::OpenGL PROPERTY IMPORTED_SONAME_RELEASE "${_qt_imported_soname}")
endif()
...
if(_qt_imported_soname)
    set_property(TARGET Qt6::OpenGL PROPERTY IMPORTED_SONAME_MINSIZEREL "${_qt_imported_soname}")
endif()
...
if(_qt_imported_soname_default)
    set_property(TARGET Qt6::OpenGL PROPERTY IMPORTED_SONAME "${_qt_imported_soname_default}")
endif()
