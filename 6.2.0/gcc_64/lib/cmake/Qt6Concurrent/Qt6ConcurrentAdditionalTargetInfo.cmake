...
get_target_property(_qt_imported_location Qt6::Concurrent IMPORTED_LOCATION_RELWITHDEBINFO)
get_target_property(_qt_imported_soname Qt6::Concurrent IMPORTED_SONAME_RELWITHDEBINFO)
...
if(_qt_imported_location)
    set_property(TARGET Qt6::Concurrent PROPERTY IMPORTED_LOCATION_RELEASE "${_qt_imported_location}")
endif()
if(_qt_imported_soname)
    set_property(TARGET Qt6::Concurrent PROPERTY IMPORTED_SONAME_RELEASE "${_qt_imported_soname}")
endif()
...
if(_qt_imported_soname)
    set_property(TARGET Qt6::Concurrent PROPERTY IMPORTED_SONAME_MINSIZEREL "${_qt_imported_soname}")
endif()
