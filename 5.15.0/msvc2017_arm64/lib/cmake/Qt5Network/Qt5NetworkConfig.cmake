...
if (NOT TARGET Qt5::Network)
    ...
    set_property(TARGET Qt5::Network PROPERTY INTERFACE_QT_ENABLED_FEATURES networkinterface;bearermanagement;dnslookup;ftp;http;localserver;networkdiskcache;networkproxy;schannel;socks5;ssl;sspi;udpsocket)
    set_property(TARGET Qt5::Network PROPERTY INTERFACE_QT_DISABLED_FEATURES dtls;gssapi;opensslv11;ocsp;sctp;securetransport)

    # Qt 6 forward compatible properties.
    set_property(TARGET Qt5::Network
                 PROPERTY QT_ENABLED_PUBLIC_FEATURES
                 networkinterface;bearermanagement;dnslookup;ftp;http;localserver;networkdiskcache;networkproxy;schannel;socks5;ssl;sspi;udpsocket)
    set_property(TARGET Qt5::Network
                 PROPERTY QT_DISABLED_PUBLIC_FEATURES
                 dtls;gssapi;opensslv11;ocsp;sctp;securetransport)
    set_property(TARGET Qt5::Network
                 PROPERTY QT_ENABLED_PRIVATE_FEATURES
                 netlistmgr;system-proxies)
    set_property(TARGET Qt5::Network
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 openssl;openssl-linked;libproxy;linux-netlink)
