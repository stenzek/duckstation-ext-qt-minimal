...
get_target_property(_qt_imported_soname Qt6::Concurrent IMPORTED_SONAME_RELEASE)
...
if(_qt_imported_soname)
    set_property(TARGET Qt6::Concurrent PROPERTY IMPORTED_SONAME_RELWITHDEBINFO "${_qt_imported_soname}")
endif()
